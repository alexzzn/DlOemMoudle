...
- (void)buildTextViews
{
    if (!self.editorView) {
        ...
        self.titlePlaceholderText = NSLocalizedString(@"请输入标题",  @"Placeholder for the post title.");
        self.bodyPlaceholderText = NSLocalizedString(@"请输入您要记录的内容", @"Placeholder for the post body.");
    }
